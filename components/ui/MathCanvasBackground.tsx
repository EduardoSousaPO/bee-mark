...
export function MathCanvasBackground({
  ...
  useEffect(() => {
    ...
    const resetPoints = () => {
      ...
      const count = Math.min(240, Math.max(80, Math.floor(area / 16000)));
    ...
    const draw = () => {
      ...
      // Trail sutil para sensação hipnótica sem ruído visual excessivo.
      ...
      for (let i = 0; i < points.length; i += 1) {
        ...
        const speed = 0.7 + 0.3 * Math.sin(t * 2.0 + i * 0.05);
